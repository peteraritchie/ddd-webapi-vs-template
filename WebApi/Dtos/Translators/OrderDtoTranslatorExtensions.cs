...
namespace WebApi.Dtos.Translators
{
	public static class OrderDtoTranslatorExtensions
	{
		...
		public static OrderLineItem ToDomain(this OrderItemDto orderItem)
		{
			if (orderItem.UnitQuantity == null)
			{
				throw new ArgumentException(
					$"{nameof(orderItem)}.{nameof(orderItem.UnitQuantity)} should not be null.",
					nameof(orderItem));
			}
			...
			{
				throw new ArgumentException(
					$"{nameof(orderItem)}.{nameof(orderItem.SkuText)} should not be null.",
					nameof(orderItem));
			}
			...
			{
				throw new ArgumentException(
					$"{nameof(orderItem)}.{nameof(orderItem.UnitPrice)} should not be null.",
					nameof(orderItem));
			}

			return new OrderLineItem(
				orderItem.SkuText,
				(ushort)orderItem.UnitQuantity,
		...
		public static PostalAddress ToDomain(this PostalAddressDto? address)
		{
			...
			{
				throw new ArgumentException(
					$"{nameof(address)}.{nameof(address.StreetAddress)} should not be null.",
					nameof(address));
			}
			...
			{
				throw new ArgumentException(
					$"{nameof(address)}.{nameof(address.CityName)} should not be null.",
					nameof(address));
			}
			...
			{
				throw new ArgumentException(
					$"{nameof(address)}.{nameof(address.StateName)} should not be null.",
					nameof(address));
			}
			...
			{
				throw new ArgumentException(
					$"{nameof(address)}.{nameof(address.PostalCodeText)} should not be null.",
					nameof(address));
			}
			...
			return new PostalAddress(
				...
				address.CityName,
				address.StateName,
				address.PostalCodeText,
				address.AlternateLocationText,
				address.AttentionText);
		}
	}
}
