...
{
	private readonly CosmosDbService<Infrastructure.Dtos.OrderDto> databaseService;

	public CosmosOrderRepository(CosmosDbService<Infrastructure.Dtos.OrderDto> databaseService)
	{
	...
	public async Task CreateAsync(Guid orderId, Order order)
	{
		...
		var orderDto = OrderDtoTranslator.FromDomain(orderId, order);
