...
{
    public CreateOrder(Guid correlationId, DateTime dateTime, IEnumerable<OrderLineItem> orderItems, PostalAddress shippingAddress)
        ...
        PostalAddress? billingAddress)
    {
        ...
        if (PostalAddress.TryValidate(shippingAddress))
            throw new ArgumentException("Shipping address should be valid and not missing.", nameof(shippingAddress));
